...
// Namespace is declared in `packages/standard-library/sources/*.es` and so has an entry, but the
...
describe("Builtins", () => {
	...
	// README warns about: a Namespace declared in `packages/standard-library/sources` but missing from
