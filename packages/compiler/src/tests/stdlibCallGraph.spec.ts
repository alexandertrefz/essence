...
describe("Stdlib Call Graph", () => {
	...
	it("names every Essence-implemented Method and free Function as a Node", () => {
		...
		expect([...graph.keys()].sort()).toEqual([
			...
			"Number.highestNumber__overload$1",
			"Number.highestNumber__overload$10",
			"Number.highestNumber__overload$11",
			"Number.highestNumber__overload$12",
			"Number.highestNumber__overload$13",
			"Number.highestNumber__overload$2",
			"Number.highestNumber__overload$3",
			"Number.highestNumber__overload$4",
			"Number.highestNumber__overload$5",
			"Number.highestNumber__overload$6",
			"Number.highestNumber__overload$7",
			"Number.highestNumber__overload$8",
			"Number.highestNumber__overload$9",
			"Number.is",
			"Number.lowestNumber__overload$1",
			"Number.lowestNumber__overload$10",
			"Number.lowestNumber__overload$11",
			"Number.lowestNumber__overload$12",
			"Number.lowestNumber__overload$13",
			...
			"Number.lowestNumber__overload$8",
			"Number.lowestNumber__overload$9",
