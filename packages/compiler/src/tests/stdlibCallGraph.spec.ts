...
describe("Stdlib Call Graph", () => {
	...
	it("names every Essence-implemented Method and free Function as a Node", () => {
		...
		expect([...graph.keys()].sort()).toEqual([
			...
			"IntegerList.greatestNumber__overload$1",
			"IntegerList.greatestNumber__overload$2",
			...
			"List.greatestItem__overload$1",
			"List.greatestItem__overload$2",
			...
			"Number.greatestNumber__overload$10",
			"Number.greatestNumber__overload$11",
			"Number.greatestNumber__overload$12",
			"Number.greatestNumber__overload$13",
			...
			"Number.greatestNumber__overload$8",
			"Number.greatestNumber__overload$9",
			"Number.is",
			...
			"NumberList.greatestNumber__overload$2",
			...
			"RationalList.greatestNumber__overload$1",
			"RationalList.greatestNumber__overload$2",
