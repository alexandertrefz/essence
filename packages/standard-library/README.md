...
with `NestedList`, `NonEmptyList` and the `NonEmptyNestedList` that only both of
those proofs together reach. A checked refinement is exported beside the base it
