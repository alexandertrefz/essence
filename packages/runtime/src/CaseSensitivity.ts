...
// and `is`, `isNot` and `toString` are implemented in Essence
// (`packages/standard-library/sources/String.es`, beside the comparison Methods
// that take one). Nothing but the tags lives here. Unlike `Side`, no native
