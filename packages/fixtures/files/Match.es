implementation {
	...
	Terminal.inspect(match amount -> String {
	...
	Terminal.inspect(describe(0)) § "none"
	Terminal.inspect(describe(1)) § "exactly one"
	Terminal.inspect(describe(0::subtract(2))) § "less than none?"
	Terminal.inspect(describe(7)) § "many"
	Terminal.inspect(describe("lots")) § "not a count at all: lots"
	...
	Terminal.inspect(readCount("7")) § "many"
	Terminal.inspect(readCount("seven")) § "no count at all"
