implementation {
	...
	show("String.pad(to: Integer, with: String, at: Side) [end, already long enough]", greeting::pad(to 3, with ".", at Side#End))
	show("String.pad(to: Integer, with: String, at: Side) [both ends, even]", "7"::pad(to 5, with "-", at Side#BothEnds))
	show("String.pad(to: Integer, with: String, at: Side) [both ends, odd]", "7"::pad(to 4, with "-", at Side#BothEnds))
	show("String.pad(to: Integer, with: String, at: Side) [both ends, multi-character]", "ab"::pad(to 8, with "xy", at Side#BothEnds))
	...
	showMaybe("Integer.quotient(dividingBy: Integer)", 7::quotient(dividingBy 3))
	showMaybe("Integer.quotient(dividingBy: Integer) [negative dividend]", -7::quotient(dividingBy 3))
	showMaybe("Integer.quotient(dividingBy: Integer) [negative divisor]", 7::quotient(dividingBy -3))
	showMaybe("Integer.quotient(dividingBy: Integer) [by zero]", 7::quotient(dividingBy 0))
