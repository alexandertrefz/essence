implementation {
	...
	§ ——— List —————————————————————————————————————————————————————————————
	show("List.is<ItemType>(_ List<ItemType>)", numbers::is([3, 1, 2, 1, 4]))
	show("List.is<ItemType>(_ List<ItemType>) [differing]", numbers::is(singleNumber))
	show("List.is<ItemType>(_ List<ItemType>) [both empty]", noNumbers::is([]))
	show("List.isNot<ItemType>(_ List<ItemType>)", numbers::isNot(singleNumber))
	show("List.isNot<ItemType>(_ List<ItemType>) [equal]", numbers::isNot([3, 1, 2, 1, 4]))
	...
	show("List.contains<ItemType>(_ ItemType)", numbers::contains(4))
	show("List.contains<ItemType>(_ ItemType) [absent]", numbers::contains(9))
	show("List.doesNotContain<ItemType>(_ ItemType)", numbers::doesNotContain(9))
	show("List.doesNotContain<ItemType>(_ ItemType) [present]", numbers::doesNotContain(4))
	...
	show("List.removeEvery<ItemType>(_ ItemType)", numbers::removeEvery(1))
	show("List.removeEvery<ItemType>(_ ItemType) [absent]", numbers::removeEvery(9))
	...
	show("List.removeDuplicates<ItemType>()", numbers::removeDuplicates())
	show("List.removeDuplicates<ItemType>() [empty]", noNumbers::removeDuplicates())
	...
	showMaybe("List.firstIndexOf<ItemType>(_ ItemType)", numbers::firstIndexOf(1))
	showMaybe("List.firstIndexOf<ItemType>(_ ItemType) [absent]", numbers::firstIndexOf(9))
	...
	show("List.countOf<ItemType>(_ ItemType)", numbers::countOf(1))
	show("List.countOf<ItemType>(_ ItemType) [absent]", numbers::countOf(9))
	...
	showMaybe("List.lastIndexOf<ItemType>(_ ItemType)", numbers::lastIndexOf(1))
	showMaybe("List.lastIndexOf<ItemType>(_ ItemType) [absent]", numbers::lastIndexOf(9))
